...
def build_package() -> Path:
    ...
    build_dir = Path(tempfile.mkdtemp(prefix="ensemble-build-", dir=module_dir))
    package_dir = build_dir / "package"
    zip_path = module_dir / "lambda" / "ensemble_agent.zip"
    temp_zip_path = build_dir / "ensemble_agent.zip"
    requirements_file = project_root / "src" / "agents" / "EnsembleAgent" / "requirements.lambda.txt"
    ...
    files_to_copy = {
        ...
        project_root / "src" / "agents" / "EnsembleAgent" / "preprocessor.py": package_dir / "src" / "agents" / "EnsembleAgent" / "preprocessor.py",
        project_root / "src" / "agents" / "EnsembleAgent" / "ensemble_agent.py": package_dir / "src" / "agents" / "EnsembleAgent" / "ensemble_agent.py",
        project_root / "src" / "agents" / "EnsembleAgent" / "lambda_handler.py": package_dir / "src" / "agents" / "EnsembleAgent" / "lambda_handler.py",
    }
