...
from src.agents.ScannerAgent.deals import ScrapedDeal, DealSelection
...
class ScannerAgent(Agent):
    ...
    def __init__(self):
        ...
        self.openai = OpenAI(api_key=self._load_openai_api_key())
    ...
    def _load_openai_api_key(self) -> str:
        ...
        if secret_arn:
            ...
            client = boto3.session.Session(region_name=region).client("secretsmanager")
